...
#c.JupyterHub.data_files_path = '/opt/app-root/share/jupyterhub'
...
#  - Start with `/notebooks` instead of `/tree` if `default_url` points to a notebook insteadof a directory.
